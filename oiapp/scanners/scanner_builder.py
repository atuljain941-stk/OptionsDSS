...
INDICATORS = [
    ...
    "distancefromresistance", "distancefromsupport", "atrcompression", "rangecompression", "volumedryup",
...
FUNCTION_CATALOG = [
    ...
    {"name": "ChangePct", "signature": "ChangePct(expr[, bars][, timeframe])", "description": "Percent change over N bars; default bars=1"},
    {"name": "AvgAbsChangePct", "signature": "AvgAbsChangePct(bars[, timeframe])", "description": "EMA of absolute one-bar ChangePct over prior N bars"},
    {"name": "EMAAbsChangePct", "signature": "EMAAbsChangePct(bars[, timeframe])", "description": "Alias for AvgAbsChangePct; EMA(abs(ChangePct), N)"},
    {"name": "Abs", "signature": "Abs(expr)", "description": "Absolute value"},
    {"name": "Round", "signature": "Round(expr[, decimals])", "description": "Round a primitive/expression. Round(x) returns an integer; Round(x, 2) keeps two decimals."},
    ...
    {"name": "Slope", "signature": "Slope(expr, bars[, timeframe])", "description": "Raw endpoint slope per bar over the lookback window"},
    {"name": "SlopePct", "signature": "SlopePct(expr, bars[, timeframe])", "description": "Total endpoint percent move from expr[bars] to current, e.g. close vs close[10]"},
    {"name": "SlopeDeg", "signature": "SlopeDeg(expr, bars[, timeframe])", "description": "Raw endpoint angle: degrees(atan((current - expr[bars]) / bars))"},
    {"name": "SlopePctPerBar", "signature": "SlopePctPerBar(expr, bars[, timeframe])", "description": "Endpoint percent move divided by bars; old SlopePct behavior"},
    {"name": "SlopeDegPerBar", "signature": "SlopeDegPerBar(expr, bars[, timeframe])", "description": "Endpoint percent-per-bar angle; old SlopeDeg behavior"},
    {"name": "SlopeDegRaw", "signature": "SlopeDegRaw(expr, bars[, timeframe])", "description": "Alias for SlopeDeg; raw endpoint angle"},
    {"name": "SlopeATR", "signature": "SlopeATR(expr, bars[, timeframe])", "description": "Endpoint slope measured in ATRs per bar"},
    {"name": "SlopeATRDeg", "signature": "SlopeATRDeg(expr, bars[, timeframe])", "description": "Endpoint ATR-normalized slope angle in degrees"},
    {"name": "RegSlopePct", "signature": "RegSlopePct(expr, bars[, timeframe])", "description": "Least-squares regression slope over the lookback window, normalized to percent per bar"},
    {"name": "RegSlopeDeg", "signature": "RegSlopeDeg(expr, bars[, timeframe])", "description": "Least-squares regression angle over the lookback window, using percent-per-bar slope"},
    {"name": "RegSlopeATR", "signature": "RegSlopeATR(expr, bars[, timeframe])", "description": "Least-squares regression slope over the lookback window, measured in ATRs per bar"},
    {"name": "RegSlopeATRDeg", "signature": "RegSlopeATRDeg(expr, bars[, timeframe])", "description": "Least-squares regression ATR-normalized slope angle in degrees"},
    ...
    {"name": "Highest", "signature": "Highest(expr, bars[, timeframe])", "description": "Highest value of an expression"},
    {"name": "Lowest", "signature": "Lowest(expr, bars[, timeframe])", "description": "Lowest value of an expression"},
    {"name": "stddev", "signature": "stddev(expr, bars)", "description": "Standard deviation of an expression"},
    {"name": "CrossAbove", "signature": "CrossAbove(series, level[, timeframe])", "description": "True when a series crosses above a level"},
    {"name": "CrossOver", "signature": "CrossOver(series, level[, timeframe])", "description": "Alias for CrossAbove(series, level[, timeframe])"},
    {"name": "CrossBelow", "signature": "CrossBelow(series, level[, timeframe])", "description": "True when a series crosses below a level"},
    {"name": "CrossUnder", "signature": "CrossUnder(series, level[, timeframe])", "description": "Alias for CrossBelow(series, level[, timeframe])"},
    {"name": "LastSwingHigh", "signature": "LastSwingHigh(lookback[, left[, right[, timeframe]]])", "description": "High price of the most recent confirmed swing-high pivot"},
    {"name": "LastSwingHighClose", "signature": "LastSwingHighClose(lookback[, left[, right[, timeframe]]])", "description": "Close of the most recent confirmed swing-high candle"},
    {"name": "LastSwingHighOpen", "signature": "LastSwingHighOpen(lookback[, left[, right[, timeframe]]])", "description": "Open of the most recent confirmed swing-high candle"},
    {"name": "LastSwingHighLow", "signature": "LastSwingHighLow(lookback[, left[, right[, timeframe]]])", "description": "Low of the most recent confirmed swing-high candle"},
    {"name": "LastSwingHighAge", "signature": "LastSwingHighAge(lookback[, left[, right[, timeframe]]])", "description": "Bars since the most recent confirmed swing high"},
    {"name": "DaysSinceSwingHigh", "signature": "DaysSinceSwingHigh(lookback[, left[, right[, timeframe]]])", "description": "Alias for LastSwingHighAge; on daily charts this is trading days"},
    {"name": "PullbackFromSwingHighPct", "signature": "PullbackFromSwingHighPct(lookback[, left[, right[, timeframe]]])", "description": "Percent pullback from the last swing-high price to the lowest low after that swing"},
    {"name": "PullbackFromSwingHighATR", "signature": "PullbackFromSwingHighATR(lookback[, left[, right[, timeframe]]])", "description": "Pullback depth from last swing high measured in current ATR(14) multiples"},
    {"name": "LastSwingLow", "signature": "LastSwingLow(lookback[, left[, right[, timeframe]]])", "description": "Low price of the most recent confirmed swing-low pivot"},
    {"name": "LastSwingLowClose", "signature": "LastSwingLowClose(lookback[, left[, right[, timeframe]]])", "description": "Close of the most recent confirmed swing-low candle"},
    {"name": "LastSwingLowOpen", "signature": "LastSwingLowOpen(lookback[, left[, right[, timeframe]]])", "description": "Open of the most recent confirmed swing-low candle"},
    {"name": "LastSwingLowHigh", "signature": "LastSwingLowHigh(lookback[, left[, right[, timeframe]]])", "description": "High of the most recent confirmed swing-low candle"},
    {"name": "LastSwingLowAge", "signature": "LastSwingLowAge(lookback[, left[, right[, timeframe]]])", "description": "Bars since the most recent confirmed swing low"},
    {"name": "DaysSinceSwingLow", "signature": "DaysSinceSwingLow(lookback[, left[, right[, timeframe]]])", "description": "Alias for LastSwingLowAge; on daily charts this is trading days"},
    {"name": "BounceFromSwingLowPct", "signature": "BounceFromSwingLowPct(lookback[, left[, right[, timeframe]]])", "description": "Percent bounce from the last swing-low price to the highest high after that swing"},
    {"name": "BounceFromSwingLowATR", "signature": "BounceFromSwingLowATR(lookback[, left[, right[, timeframe]]])", "description": "Bounce depth from last swing low measured in current ATR(14) multiples"},
    {"name": "Retest", "signature": "Retest(level, tolerancePct, bars[, timeframe])", "description": "True when price retests a level after a cross"},
    {"name": "StrongBullCandle", "signature": "StrongBullCandle(lookback[, timeframe[, minBodyPct[, moveMult[, minVolMult[, avgBars]]]]])", "description": "True when a prior bull candle ChangePct >= moveMult x EMA(abs(ChangePct), avgBars)"},
    {"name": "StrongBearCandle", "signature": "StrongBearCandle(lookback[, timeframe[, minBodyPct[, moveMult[, minVolMult[, avgBars]]]]])", "description": "True when a prior bear candle ChangePct <= -moveMult x EMA(abs(ChangePct), avgBars)"},
    {"name": "StrongCandleAge", "signature": "StrongCandleAge(side, lookback[, timeframe[, minBodyPct[, moveMult[, minVolMult[, avgBars]]]]])", "description": "Bars ago for the most recent strong bull/bear anchor candle"},
    {"name": "StrongCandleHigh", "signature": "StrongCandleHigh(side, lookback[, timeframe[, minBodyPct[, moveMult[, minVolMult[, avgBars]]]]])", "description": "High of the most recent strong bull/bear anchor candle"},
    {"name": "StrongCandleLow", "signature": "StrongCandleLow(side, lookback[, timeframe[, minBodyPct[, moveMult[, minVolMult[, avgBars]]]]])", "description": "Low of the most recent strong bull/bear anchor candle"},
    {"name": "StrongCandleOpen", "signature": "StrongCandleOpen(side, lookback[, timeframe[, minBodyPct[, moveMult[, minVolMult[, avgBars]]]]])", "description": "Open of the most recent strong bull/bear anchor candle"},
    {"name": "StrongCandleClose", "signature": "StrongCandleClose(side, lookback[, timeframe[, minBodyPct[, moveMult[, minVolMult[, avgBars]]]]])", "description": "Close of the most recent strong bull/bear anchor candle"},
    {"name": "StrongCandleChangePct", "signature": "StrongCandleChangePct(side, lookback[, timeframe[, minBodyPct[, moveMult[, minVolMult[, avgBars]]]]])", "description": "One-bar percent change of the matched strong candle"},
    {"name": "StrongCandleAvgAbsChangePct", "signature": "StrongCandleAvgAbsChangePct(side, lookback[, timeframe[, minBodyPct[, moveMult[, minVolMult[, avgBars]]]]])", "description": "Prior EMA(abs(ChangePct), avgBars) baseline used by the matched strong candle"},
    {"name": "StrongCandleMoveMultiple", "signature": "StrongCandleMoveMultiple(side, lookback[, timeframe[, minBodyPct[, moveMult[, minVolMult[, avgBars]]]]])", "description": "abs(ChangePct) divided by prior EMA(abs(ChangePct), avgBars) for the matched strong candle"},
    {"name": "StrongCandleLevel", "signature": "StrongCandleLevel(side, level, lookback[, timeframe[, minBodyPct[, moveMult[, minVolMult[, avgBars]]]]])", "description": "Price level inside the strong candle: low/high/open/close/mid or 0-100 percent"},
    {"name": "TouchStrongCandleLevel", "signature": "TouchStrongCandleLevel(side, level, lookback[, tolerancePct][, timeframe[, minBodyPct[, moveMult[, minVolMult[, avgBars]]]]])", "description": "True when current bar touches a level from the strong candle"},
    {"name": "NearStrongCandleLevel", "signature": "NearStrongCandleLevel(side, level, lookback[, tolerancePct][, timeframe[, minBodyPct[, moveMult[, minVolMult[, avgBars]]]]])", "description": "Alias for TouchStrongCandleLevel"},
    {"name": "SecondLegUp", "signature": "SecondLegUp(lookback[, timeframe[, tolerancePct[, minSwingPct[, recentBars]]]])", "description": "Potential M-top: price is retesting a prior swing high after a pullback"},
    {"name": "SecondLegDown", "signature": "SecondLegDown(lookback[, timeframe[, tolerancePct[, minSwingPct[, recentBars]]]])", "description": "Potential W-bottom: price is retesting a prior swing low after a bounce"},
    {"name": "LooseMPattern", "signature": "LooseMPattern(lookback[, timeframe[, tolerancePct[, minSwingPct[, recentBars]]]])", "description": "Alias for SecondLegUp / loose double-top pattern"},
    {"name": "LooseWPattern", "signature": "LooseWPattern(lookback[, timeframe[, tolerancePct[, minSwingPct[, recentBars]]]])", "description": "Alias for SecondLegDown / loose double-bottom pattern"},
    {"name": "DoubleTop", "signature": "DoubleTop(lookback[, timeframe[, tolerancePct[, minSwingPct[, recentBars]]]])", "description": "Alias for SecondLegUp"},
    {"name": "DoubleBottom", "signature": "DoubleBottom(lookback[, timeframe[, tolerancePct[, minSwingPct[, recentBars]]]])", "description": "Alias for SecondLegDown"},
    {"name": "SecondLegScore", "signature": "SecondLegScore(side, lookback[, timeframe[, tolerancePct[, minSwingPct[, recentBars]]]])", "description": "0-100 quality score for loose M/W second-leg pattern"},
    {"name": "SecondLegLevel", "signature": "SecondLegLevel(side, which, lookback[, timeframe[, tolerancePct[, minSwingPct[, recentBars]]]])", "description": "Pattern level: first, second, neckline, midpoint, target"},
    {"name": "SecondLegFirst", "signature": "SecondLegFirst(side, lookback[, timeframe[, tolerancePct[, minSwingPct[, recentBars]]]])", "description": "First swing high/low price in the M/W pattern"},
    {"name": "SecondLegSecond", "signature": "SecondLegSecond(side, lookback[, timeframe[, tolerancePct[, minSwingPct[, recentBars]]]])", "description": "Second-leg retest price in the M/W pattern"},
    {"name": "SecondLegNeckline", "signature": "SecondLegNeckline(side, lookback[, timeframe[, tolerancePct[, minSwingPct[, recentBars]]]])", "description": "Valley/peak neckline between the two legs"},
    {"name": "SecondLegMatchPct", "signature": "SecondLegMatchPct(side, lookback[, timeframe[, tolerancePct[, minSwingPct[, recentBars]]]])", "description": "Percent distance between first swing and second-leg retest"},
    {"name": "SecondLegSwingPct", "signature": "SecondLegSwingPct(side, lookback[, timeframe[, tolerancePct[, minSwingPct[, recentBars]]]])", "description": "Depth/height of the pullback between first leg and neckline"},
    {"name": "SecondLegAge", "signature": "SecondLegAge(side, lookback[, timeframe[, tolerancePct[, minSwingPct[, recentBars]]]])", "description": "Bars since the second-leg retest was touched"},
    {"name": "UAERegime", "signature": "UAERegime([timeframe])", "description": "UAE regime label: BULL, WEAK_BULL, BEAR, WEAK_BEAR, or SIDEWAYS"},
    {"name": "IsUAERegime", "signature": "IsUAERegime(regime[, timeframe])", "description": "True when the selected timeframe is in a UAE regime"},
    {"name": "UAEBull", "signature": "UAEBull([timeframe])", "description": "True when UAE regime is BULL"},
    {"name": "UAEWeakBull", "signature": "UAEWeakBull([timeframe])", "description": "True when UAE regime is WEAK_BULL"},
    {"name": "UAEBear", "signature": "UAEBear([timeframe])", "description": "True when UAE regime is BEAR"},
    {"name": "UAEWeakBear", "signature": "UAEWeakBear([timeframe])", "description": "True when UAE regime is WEAK_BEAR"},
    {"name": "UAESideways", "signature": "UAESideways([timeframe])", "description": "True when UAE regime is SIDEWAYS"},
    {"name": "UAERegimeScore", "signature": "UAERegimeScore([timeframe])", "description": "0-100 quality/confidence score for the current UAE regime"},
    {"name": "UAEADX", "signature": "UAEADX([timeframe])", "description": "UAE smoothed ADX value for the selected timeframe"},
    {"name": "UAEADXRising", "signature": "UAEADXRising([timeframe])", "description": "True when UAE smoothed ADX is rising"},
    {"name": "UAETrending", "signature": "UAETrending([timeframe])", "description": "True when RSIdiff is beyond +/-12 or UAE ADX is above the timeframe threshold"},
    {"name": "UAERSIDiff", "signature": "UAERSIDiff([timeframe])", "description": "Exact UAE RSIdiff value: RSI(14) minus EMA(RSI,90)"},
    {"name": "UAEMACD", "signature": "UAEMACD([timeframe])", "description": "Exact UAE custom MACD line from the Pine Trend/Vol Analyzer"},
    {"name": "UAESignal", "signature": "UAESignal([timeframe])", "description": "Exact UAE custom signal line from the Pine Trend/Vol Analyzer"},
    {"name": "UAEHist", "signature": "UAEHist([timeframe])", "description": "UAE custom histogram value"},
    {"name": "UAEHistThreshold", "signature": "UAEHistThreshold([timeframe])", "description": "60th percentile strong-hist threshold over the 100-bar UAE lookback"},
    {"name": "UAEStrongHist", "signature": "UAEStrongHist([timeframe])", "description": "True when abs(UAE hist) is above the strong-hist percentile threshold"},
    {"name": "UAEHistGrowing", "signature": "UAEHistGrowing([timeframe])", "description": "True when absolute UAE histogram is growing"},
    {"name": "MACDDiff", "signature": "MACDDiff([timeframe])", "description": "MACD line minus MACD signal line; same as MACD histogram"},
    {"name": "MACDSpread", "signature": "MACDSpread([timeframe])", "description": "Alias for MACDDiff"},
    {"name": "MACDGap", "signature": "MACDGap([timeframe])", "description": "Alias for MACDDiff"},
    {"name": "MACDDiffAbs", "signature": "MACDDiffAbs([timeframe])", "description": "Absolute distance between MACD and signal"},
    {"name": "MACDDiffPct", "signature": "MACDDiffPct([timeframe])", "description": "MACD minus signal as percent of close"},
    {"name": "MACDSpreadRatio", "signature": "MACDSpreadRatio([lookback][, timeframe])", "description": "Abs MACD spread divided by its average abs spread over lookback"},
    {"name": "MACDDiffShrinkPct", "signature": "MACDDiffShrinkPct([bars][, timeframe])", "description": "Percent shrink in abs MACD-signal gap versus N bars ago; negative means expanding"},
    {"name": "MACDSpreadStable", "signature": "MACDSpreadStable([side,][maxShrinkPct[, bars]][, timeframe])", "description": "True when MACD spread has not shrunk much; optional bull/bear side"},
    {"name": "MACDFarFromSignal", "signature": "MACDFarFromSignal([side,] minPct[, timeframe])", "description": "True when MACD is still meaningfully separated from signal"},
    {"name": "UAEDiamond", "signature": "UAEDiamond(side[, timeframe])", "description": "Optional UAE strong-hist diamond for side bull/bear"},
    {"name": "UAETrendTriangle", "signature": "UAETrendTriangle(side[, timeframe[, mode]])", "description": "Visible Pine v5 trend triangle: MACD zero-cross + UAE trending + strong hist, suppressed on fade-arrow bars. Weekly/monthly default to confirmed bars; pass \"live\" to include the forming bar."},
    {"name": "UAETrendTriangleAge", "signature": "UAETrendTriangleAge(side[, timeframe[, bars]])", "description": "Bars ago for the most recent visible UAE trend triangle; weekly/monthly use confirmed bars by default"},
    {"name": "UAETrendTriangleDate", "signature": "UAETrendTriangleDate(side[, timeframe[, bars]])", "description": "Date of the most recent visible UAE trend triangle inside the lookback window"},
    {"name": "UAELastMarker", "signature": "UAELastMarker([timeframe])", "description": "Last visible UAE marker on that timeframe: TREND_BULL, TREND_BEAR, MRT_BUY, MRT_SELL, or blank"},
    {"name": "UAELastMarkerAge", "signature": "UAELastMarkerAge([timeframe[, bars]])", "description": "Bars ago for the most recent visible UAE marker"},
    {"name": "UAESolidTriangle", "signature": "UAESolidTriangle(side[, timeframe])", "description": "Alias for UAETrendTriangle"},
    {"name": "UAEWeakTriangle", "signature": "UAEWeakTriangle(side[, timeframe])", "description": "Legacy helper: MACD zero-cross while trending but below strong-hist threshold"},
    {"name": "UAEFadeArrow", "signature": "UAEFadeArrow(side[, timeframe[, mode]])", "description": "Visible Pine v5 fade/MRT arrow: bear = RSIdiff crosses below +20; bull = RSIdiff crosses above -20. Weekly/monthly default to confirmed bars; pass \"live\" to include the forming bar."},
    {"name": "UAEFadeArrowAge", "signature": "UAEFadeArrowAge(side[, timeframe[, bars]])", "description": "Bars ago for the most recent visible UAE fade/MRT arrow"},
    {"name": "UAEMRTArrow", "signature": "UAEMRTArrow(side[, timeframe])", "description": "Alias for UAEFadeArrow"},
    {"name": "UAECircle", "signature": "UAECircle(side[, timeframe])", "description": "Optional UAE histogram zero-cross circle"},
    {"name": "UAEConfluence", "signature": "UAEConfluence(side[, timeframe[, bars]])", "description": "Counts trend triangle, circle, diamond, and fade-arrow signals over the lookback window"},
    ...
    {"name": "RSIDiff", "signature": "RSIDiff(period[, timeframe])", "description": "RSI minus its EMA"},
    {"name": "RSIDiff90", "signature": "RSIDiff90([timeframe])", "description": "RSI minus its 90 EMA"},
    ...
    {"name": "SectorRS", "signature": "SectorRS([period[, timeframe]])", "description": "Stock return minus its sector ETF return over the lookback period; positive means outperforming sector"},
    {"name": "RelativeStrength", "signature": "RelativeStrength(benchmark[, period[, timeframe]])", "description": "Stock return minus benchmark return over the lookback period"},
    {"name": "MansfieldRS", "signature": "MansfieldRS([period[, benchmark[, timeframe]]])", "description": "Mansfield-style RS line vs benchmark"},
    {"name": "RSRank", "signature": "RSRank([period[, benchmark[, timeframe]]])", "description": "Relative-strength percentile rank"},
    {"name": "IVRank", "signature": "IVRank([timeframe])", "description": "Implied-volatility rank / fear percentile (proxy from historical vol)"},
    {"name": "IVChange", "signature": "IVChange([timeframe])", "description": "Change in implied-volatility rank / fear factor"},
    {"name": "FlowScore", "signature": "FlowScore([timeframe])", "description": "Composite weekly options flow score"},
    {"name": "FlowBias", "signature": "FlowBias([timeframe])", "description": "Composite flow bias: BULL, BEAR, or NEUTRAL"},
    {"name": "PCRShift", "signature": "PCRShift([bars])", "description": "Change in put/call ratio over the lookback window"},
    {"name": "Resistance", "signature": "Resistance(period[, timeframe])", "description": "Rolling resistance level"},
    {"name": "Support", "signature": "Support(period[, timeframe])", "description": "Rolling support level"},
    {"name": "ResistanceUpper", "signature": "ResistanceUpper(period[, timeframe])", "description": "Upper edge of the selected resistance zone"},
    {"name": "ResistanceLower", "signature": "ResistanceLower(period[, timeframe])", "description": "Lower edge of the selected resistance zone"},
    {"name": "SupportUpper", "signature": "SupportUpper(period[, timeframe])", "description": "Upper edge of the selected support zone"},
    {"name": "SupportLower", "signature": "SupportLower(period[, timeframe])", "description": "Lower edge of the selected support zone"},
    {"name": "InsideResistanceZone", "signature": "InsideResistanceZone(period[, timeframe])", "description": "True when price is inside the selected resistance zone"},
    {"name": "InsideSupportZone", "signature": "InsideSupportZone(period[, timeframe])", "description": "True when price is inside the selected support zone"},
    {"name": "TouchCount", "signature": "TouchCount(level, tolerance, bars[, timeframe])", "description": "Touch count around a level"},
    {"name": "BreakoutStrength", "signature": "BreakoutStrength([timeframe])", "description": "Quality of the breakout candle"},
    {"name": "BreakoutAge", "signature": "BreakoutAge(level, direction, bars[, timeframe])", "description": "Bars since breakout"},
    {"name": "DistanceFromResistance", "signature": "DistanceFromResistance(period[, timeframe])", "description": "Distance from rolling resistance"},
    {"name": "DistanceFromSupport", "signature": "DistanceFromSupport(period[, timeframe])", "description": "Distance from rolling support"},
    {"name": "ATRCompression", "signature": "ATRCompression([period[, timeframe]])", "description": "ATR compression score"},
    {"name": "RangeCompression", "signature": "RangeCompression([period[, timeframe]])", "description": "Range compression score"},
    {"name": "VolumeDryup", "signature": "VolumeDryup([period[, timeframe]])", "description": "Volume dry-up score"},
    {"name": "ResistanceStrength", "signature": "ResistanceStrength([period[, timeframe[, bars[, tolerance]]]])", "description": "Composite resistance strength score"},
    {"name": "SupportStrength", "signature": "SupportStrength([period[, timeframe[, bars[, tolerance]]]])", "description": "Composite support strength score"},
    {"name": "FailedBreakoutStrength", "signature": "FailedBreakoutStrength([period[, timeframe[, bars[, tolerance]]]])", "description": "Failed breakout trap score"},
    {"name": "BreakoutFailedStrength", "signature": "BreakoutFailedStrength([period[, timeframe[, bars[, tolerance]]]])", "description": "Alias for failed breakout trap score"},
    {"name": "FailedBreakdownStrength", "signature": "FailedBreakdownStrength([period[, timeframe[, bars[, tolerance]]]])", "description": "Failed breakdown reclaim score"},
    {"name": "VolumeAtLevel", "signature": "VolumeAtLevel(level[, tolerance[, bars[, timeframe]]])", "description": "Average volume at a level"},
    {"name": "OIChange", "signature": "OIChange([bars])", "description": "Open interest change"},
    {"name": "OIChangePct", "signature": "OIChangePct([bars])", "description": "Open interest percent change"},
    {"name": "PCRChange", "signature": "PCRChange([bars])", "description": "Put/call ratio change"},
    {"name": "PCRChangePct", "signature": "PCRChangePct([bars])", "description": "Put/call ratio percent change"},
    ...
    {"name": "ConvictionScore", "signature": "ConvictionScore(side[, timeframe[, lookback]])", "description": "Composite conviction score from OI, sector, market, RS and flow"},
    {"name": "ConvictionBreakdown", "signature": "ConvictionBreakdown(side[, timeframe[, lookback]])", "description": "Component breakdown for the conviction score"},
    {"name": "WPattern", "signature": "WPattern(bars[, timeframe[, strictness]])", "description": "Bullish W / double-bottom pattern confirmation"},
    {"name": "WPatternStrength", "signature": "WPatternStrength(bars[, timeframe[, strictness]])", "description": "0-100 strength score for a W pattern"},
    {"name": "MPattern", "signature": "MPattern(bars[, timeframe[, strictness]])", "description": "Bearish M / double-top pattern confirmation"},
    {"name": "MPatternStrength", "signature": "MPatternStrength(bars[, timeframe[, strictness]])", "description": "0-100 strength score for an M pattern"},
    {"name": "PatternBreakout", "signature": "PatternBreakout(patternType, bars[, timeframe[, strictness]])", "description": "Confirm a W or M pattern breakout/breakdown"},
    {"name": "IsATH", "signature": "IsATH(proximityPct, lookbackSpec)", "description": "Near all-time or rolling highs"},
    {"name": "IsATL", "signature": "IsATL(proximityPct, lookbackSpec)", "description": "Near all-time or rolling lows"},
    {"name": "ATHDistance", "signature": "ATHDistance([lookbackSpec])", "description": "Distance to ATH"},
    {"name": "ATLDistance", "signature": "ATLDistance([lookbackSpec])", "description": "Distance to ATL"},
    ...
    {"name": "StrongBullBar", "signature": "StrongBullBar([timeframe])", "description": "Strong bullish candle on high participation"},
    {"name": "StrongBearBar", "signature": "StrongBearBar([timeframe])", "description": "Strong bearish candle on high participation"},
    {"name": "StrongCandle", "signature": "StrongCandle([timeframe])", "description": "Strong directional candle on high participation"},
    {"name": "SignalBar", "signature": "SignalBar(lookbackBars[, timeframe])", "description": "High-volume low-move signal bar"},
    {"name": "SignalBarHigh", "signature": "SignalBarHigh(lookbackBars[, timeframe])", "description": "High of the most recent signal bar"},
    {"name": "SignalBarLow", "signature": "SignalBarLow(lookbackBars[, timeframe])", "description": "Low of the most recent signal bar"},
]
...
def _is_history_fresh_enough(df: Optional[pd.DataFrame], tf: str) -> bool:
    ...
    if days is None:
        return False
    tf = _normalize_tf(tf)
    max_days = 7 if tf == "1d" else 14 if tf == "1w" else 45 if tf == "1m" else 3
...
def _history(symbol: str, tf: str) -> Optional[pd.DataFrame]:
    ...
    if mode != "yf" and tf in {"1d", "1w", "1m"} and not _is_history_fresh_enough(df, tf):
        return None
    return df.copy()
...
def _symbol_ctx(symbol: str, benchmark: str, required_tfs: List[str]) -> Dict[str, Any]:
    ...
    for key in ("close", "open", "high", "low", "volume", "rsi3", "rsi14", "ema5", "ema9", "ema20", "ema50", "ema200", "ema_rsi14_13", "ema_rsi14_90", "rsi_diff_90", "macd", "macd_signal", "macd_hist", "relative_strength"):
        series = base.get(key)
    ...
    if isinstance(node, FuncCallNode):
        ...
        if fname in {"sector", "sectorname", "sector_name", "sectoretf", "sector_etf"}:
            ...
            if fname in {"sectorname", "sector_name"}:
                return ctx.get("sector_name") or ctx.get("sector")
            if fname in {"sectoretf", "sector_etf", "sector"}:
                return ctx.get("sector_etf") or ctx.get("sector")
        ...
        if fname in {"wpattern", "mpattern", "patternbreakout", "wpatternstrength", "mpatternstrength"}:
            ...
            if fname == "patternbreakout":
                if len(args2) < 2:
                    raise ValueError("PatternBreakout(patternType, bars[, timeframe[, strictness]]) expects at least 2 arguments")
        ...
        if fname in {"rsidiff", "rsidiff90", "rsi_diff"}:
            ...
            try:
                ...
                return None
        if fname in {"isath", "isatl", "athdistance", "atldistance"}:
        ...
        if fname in {"convictionscore", "conviction_score"}:
            # Syntax: ConvictionScore(side[, timeframe[, lookback]])
            side = "bull"
            tf = tf_default
            lookback = 20
            if args:
...
def _node_series(node: Node, ctx: Dict[str, Any], shift: int = 0, tf_default: str = "1d", stack: Tuple[str, ...] = ()) -> Optional[pd.Series]:
    # Only support series materialization for expressions driven by price indicators or simple arithmetic.
    tf = _normalize_tf(tf_default)
    snap = ctx.get("timeframes", {}).get(tf)
    if not snap:
        return None
...
def _series_func_value(node: Node, ctx: Dict[str, Any], period: int, tf_default: str = "1d", stack: Tuple[str, ...] = (), kind: str = "sma", shift: int = 0) -> Optional[float]:
    period = max(1, int(period or 1))
    series = _node_series(node, ctx, shift=shift, tf_default=tf_default, stack=stack)
...
def api_run():
    ...
    for r in snapshots:
        try:
            ok = bool(_eval(root, r, shift=0, tf_default="1d"))
        except Exception as e:
            ok = False
