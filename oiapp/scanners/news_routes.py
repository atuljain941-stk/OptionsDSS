...
def sector_performance():
    ...
    data = get_sector_performance(timeframe=timeframe)
    try:
        from ..services.sector_service import get_sector_advance_decline
        ad = get_sector_advance_decline()
        for row in data:
            row["breadth"] = ad.get(row.get("sector"))
    except Exception:
        pass
