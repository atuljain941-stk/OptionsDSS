"""End-of-day 1-minute extended-hours cache for intraday backtests."""
...
def fetch_symbol_intraday(symbol: str, trade_date=None) -> dict:
    ...
    for candle in candles or []:
        ...
        rows.append((symbol, ts.isoformat(), "1m", session, float(o), float(h), float(l),
                     float(cl), _value(candle, "volume", "day_volume") or 0,
    ...
    try:
        ...
        con.close()
    return {"ok": True, "symbol": symbol, "bars": len(rows), "premarket_bars": len(pm)}
